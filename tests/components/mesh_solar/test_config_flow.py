...
from custom_components.mesh_solar.bootstrap import (
    BootstrapData,
    ForecastBootstrapConfig,
    TrialAvailability,
)
from custom_components.mesh_solar.config_flow import (
    MeshSolarConfigFlow,
    _entry_title,
    _no_subscription_schema,
    _no_subscription_placeholders,
)
from custom_components.mesh_solar.oauth import OAuthRuntimeConfig
...
async def test_user_flow_create_account_generates_portal_oauth_url(hass) -> None:
    ...
    with (
        ...
        patch(
            "custom_components.mesh_solar.config_flow.async_get_oauth_runtime_config",
...
async def test_user_flow_test_mode_sets_sandbox_environment(hass) -> None:
    ...
    with (
        ...
        patch(
            "custom_components.mesh_solar.config_flow.MeshSolarConfigFlow._async_begin_oauth",
...
def test_entry_title_only_labels_sandbox() -> None:
    ...
    assert _entry_title(DEFAULT_ENVIRONMENT) == "Mesh Solar"
    assert _entry_title(SANDBOX_ENVIRONMENT) == "Mesh Solar (Sandbox)"
...
def _entitled_flow() -> MeshSolarConfigFlow:
    flow = MeshSolarConfigFlow()
...
def _bootstrap_no_subscription(
    *,
    ...
    return BootstrapData(
        ...
        forecast=None,
        reason=reason,
        subscribe_url="https://mesh-forecaster.com/portal/billing",
